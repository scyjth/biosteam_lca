...
@author: cyshi
"""
from biosteam.units import Shredder
...
def baseLCA(self, location=None):
    ...
    * 'Process': (g CO2eq)
    ...
    W = self._Design['Weight of Shredder (lb)']
    GHG['Construction emission'] = {}
    if W:
        GHG['Construction emission']['Shredder'] = (W *flow.steel_e()['emission(g CO2eq)'] *0.0005)
    self._GHGs =GHG
...
# %% Replace functioins
Shredder.rho_M = construction.rho_vessel
Shredder.energy_inputs=energy_inputs
Shredder.baseLCA =baseLCA
Shredder._GHG_units = {'Process emission': 'g CO2eq/hr',
                           'Construction emission': 'g CO2eq'} 
Shredder.multiLCA = multiLCA