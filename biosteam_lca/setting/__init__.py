...
# initial set up brightway2  for static calculation 
import brightway2 as bw2
from brightway2 import Database, methods, databases#, Activity
from bw2io import strategies, config, importers
